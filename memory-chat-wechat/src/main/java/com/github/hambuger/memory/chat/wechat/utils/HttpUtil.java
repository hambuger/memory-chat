...
import com.github.hambuger.memory.chat.wechat.configuration.UOSConfig;
...
/*	public static MyHttpClient getInstance() {
    ...
    public static HttpEntity doPost(String url, String paramsStr) {
        ...
        try {
            ...
            httpPost.setHeader("client-version", UOSConfig.UOS_PATCH_CLIENT_VERSION);
            httpPost.setHeader("extspam", UOSConfig.UOS_PATCH_EXTSPAM);
    ...
    public static HttpEntity doPost(String url, String paramsStr, Map<String, String> headerMap) {
        HttpEntity entity = null;
        HttpPost httpPost;
        try {
            StringEntity params = new StringEntity(paramsStr, Consts.UTF_8);
            ...
            httpPost.setHeader("client-version", UOSConfig.UOS_PATCH_CLIENT_VERSION);
            httpPost.setHeader("extspam", UOSConfig.UOS_PATCH_EXTSPAM);
            httpPost.setHeader("referer", "https://wx2.qq.com/?&lang=zh_CN&target=t");
            if (headerMap != null) {
                Set<Entry<String, String>> entries = headerMap.entrySet();
                for (Entry<String, String> entry : entries) {
    ...
    public static HttpEntity doPostFile(String url, HttpEntity reqEntity) {
        ...
        httpPost.setHeader("Host","file.wx2.qq.com");
