package com.github.hambuger.memory.chat.wechat.api;
...
import com.github.hambuger.memory.chat.wechat.utils.LogUtil;
import com.github.hambuger.memory.chat.wechat.utils.MediaUtil;
import com.github.hambuger.memory.chat.wechat.utils.XmlStreamUtil;
...
import com.github.hambuger.memory.chat.wechat.dto.request.msg.send.WebWXModifyRemarkNameMsg;
import com.github.hambuger.memory.chat.wechat.dto.request.msg.send.WebWXSendMsgRequest;
import com.github.hambuger.memory.chat.wechat.dto.request.msg.send.WebWXSendingAppMsg;
import com.github.hambuger.memory.chat.wechat.dto.request.msg.send.WebWXSendingCardMsg;
import com.github.hambuger.memory.chat.wechat.dto.request.msg.send.WebWXSendingEmotionMsg;
import com.github.hambuger.memory.chat.wechat.dto.request.msg.send.WebWXSendingMapMsg;
import com.github.hambuger.memory.chat.wechat.dto.request.msg.send.WebWXSendingMsg;
import com.github.hambuger.memory.chat.wechat.dto.request.msg.send.WebWXSendingNotifyMsg;
import com.github.hambuger.memory.chat.wechat.dto.request.msg.send.WebWXSendingPicMsg;
import com.github.hambuger.memory.chat.wechat.dto.request.msg.send.WebWXSendingRevokeMsg;
import com.github.hambuger.memory.chat.wechat.dto.request.msg.send.WebWXSendingTextMsg;
import com.github.hambuger.memory.chat.wechat.dto.request.msg.send.WebWXSendingVideoMsg;
import com.github.hambuger.memory.chat.wechat.dto.response.msg.send.WebWXUploadMediaResponse;
...
import com.github.hambuger.memory.chat.wechat.utils.DateUtils;
import com.github.hambuger.memory.chat.wechat.utils.FileSplitAndMergeUtil;
import com.github.hambuger.memory.chat.wechat.utils.ImageUtil;
import com.github.hambuger.memory.chat.wechat.utils.MD5Util;
import com.github.hambuger.memory.chat.wechat.utils.MimeTypeUtil;
                ...
                if (StringUtils.isEmpty(toUserName)) {
                    ...
                    switch (byCode) {
                        ...
                        case MSGTYPE_TEXT:
                            ...
                            break;
                        case MSGTYPE_VIDEO:
                            sendMsgResponse = sendVideoMsgByUserId(toUserName, message.getFilePath(), content);
                            break;
                        case MSGTYPE_MAP:
...
//    }
     ...
     * @date 201714年5月7日 下午10:34:24
     */
    private static WebWXSendMsgResponse sendVideoMsgByUserId(String userId, String filePath, String content) throws WebWXException, IOException {
        String mediaId = "";
