package io.github.memorychat.rag;
...
public class LangChainRag {
    ...
    public static String generateAnswerWithAiRAG(String question) {
        ...
        Assistant assistant = AiServices.builder(Assistant.class).chatLanguageModel(model).contentRetriever(EmbeddingStoreContentRetriever.from(embeddingStore)).build();
