...
picovoice_access_key = os.getenv("PICOVOICE_ACCESS_KEY","oH7xQFgfFONcVY2ll3a7p07sxBBvZqd6dy116lzeig4a2UGmE0+EtQ==")
model_dir = os.getenv('KWS_MODEL_DIR', os.getcwd())

porcupine = pvporcupine.create(
    access_key=picovoice_access_key,
    keyword_paths=[os.path.join(model_dir, 'andrew_zh_windows_v2_2_0.ppn')],
