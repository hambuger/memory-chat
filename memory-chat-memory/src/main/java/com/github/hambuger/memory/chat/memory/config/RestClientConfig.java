    ...
    public RestClientCustomizer restClientCustomizer() {
        return restClientBuilder -> restClientBuilder
                .requestFactory(ClientHttpRequestFactories.get(ClientHttpRequestFactorySettings.DEFAULTS
                        ...
                        .withReadTimeout(Duration.ofSeconds(10000))));
    }
}
...
//                RequestConfig.custom().setConnectionKeepAlive(TimeValue.ofSeconds(10000)).setConnectionRequestTimeout(Timeout.ofSeconds(200000)).setResponseTimeout(Timeout.ofSeconds(200000)).build();
//
//        return HttpClients.custom().setDefaultRequestConfig(requestConfig).setConnectionManager(poolingConnectionManager).setKeepAliveStrategy(new DefaultConnectionKeepAliveStrategy()).build();
//    }
//
//
//    @Slf4j
